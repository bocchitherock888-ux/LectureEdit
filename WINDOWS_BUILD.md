# LectureEdit 0.1.0 · Windows x64 构建执行手册
...
```text
LectureEdit_0.1.0_windows-x64_multi_setup.exe
BUILD-INFO.json
BINARY-AUDIT.json
native-audit.json
build.log
...
```powershell
Get-FileHash .\LectureEdit_0.1.0_windows-x64_multi_setup.exe -Algorithm SHA256
```
